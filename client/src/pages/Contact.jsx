      ...
      <div className="container mx-auto px-4 py-8 mt-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 border border-gray-100 mb-8">
            <h2 className="text-2xl font-semibold mb-6 text-primary">Connect With Us</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <a
                    href="https://www.instagram.com/manobala2k25/"
                  ...
                  <a
                    href="http://www.linkedin.com/in/mano-bala-2k25"
                    className="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-50 transition-colors"
                  >
                  ...
                  <a
                    href="https://www.facebook.com/profile.php?id=61574460428139"
                    className="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-50 transition-colors"
                  >
